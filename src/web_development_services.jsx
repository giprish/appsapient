...
const Web_development_services =() => {
    return (
        <>
      <section className="align-items-center mb-5 " id="breadcrumb">
                <div aria-label="breadcrumb text-center">
                    <ol className="breadcrumb">
                        <div>
                            <span className="bread">Web Development Services</span>
                        </div>
                        ...
                        <div className="col-md-12">
                            <div className="row">
                                <div className="col-md-4 mb-5 mt-5 ">
                                    <div>
                                        <img src="./t1.jpg" className="img-fluid animated" width="100%" />
                                    </div>
                                </div>
                                <div className="col-md-4 mb-5 mt-5 ">
                                    <div>
                                        <img src="./t2.jpg" className="img-fluid animated" width="100%" />
                                    </div>
                                </div>
                                <div className="col-md-4 mb-5 mt-5 ">
                                    <div>
                                        <img src="./t3.jpg" className="img-fluid animated" width="100%" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default Web_development_services;